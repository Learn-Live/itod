...
def check_path(file_path, overwrite=False):
    """Check if the file_path exists or not. If not, generate the path.
    ...
    overwrite: default (True)
        If overwrite is True, we delete the folder first, then create a new folder.
