...
from itod.detector.detector_factory import DetectorFactory
...
class MainFactory:
    ...
    def run(self):
        ...
        opt_dir = self.dt.params['opt_dir']
        dataset_name = self.dt.params['dataset_name']
        output_file = pth.join(opt_dir, f'{dataset_name}/all_features-header_{header}.dat')
        print(output_file)
...
class DSP(Parameter):
    def __init__(self, ipt_dir='', opt_dir='', dataset_name='', **kwargs):
        ...
        self.ipt_dir = "data/data_reprst/input_data"  # ipt_dir
        self.opt_dir = "out/data_reprst/output_data"  # opt_dir
